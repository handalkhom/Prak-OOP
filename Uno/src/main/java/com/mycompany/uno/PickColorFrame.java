...
public class PickColorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        redButton.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        redButton.setText("Merah");
        ...
        blueButton.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        blueButton.setText("Biru");
        ...
        greenButton.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        greenButton.setText("Hijau");
        ...
        yellowButton.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        yellowButton.setText("Kuning");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(greenButton, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                            .addComponent(yellowButton, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE))))
    ...
    private void redButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_redButtonActionPerformed
        ...
        JLabel message = new JLabel("Warna Kartu Wild adalah Merah!");
        ...
        popUp.topCardButton.setIcon(new javax.swing.ImageIcon("D:\\Sistem\\Documents\\CODE\\Kuly\\s4\\Uno.java\\images\\small\\" + popUp.game.getTopCardImage()));
    ...
    private void blueButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_blueButtonActionPerformed
        ...
        JLabel message = new JLabel("Warna Kartu Wild adalah Biru!");
        message.setFont(new Font("Arial", Font.BOLD, 48));
        JOptionPane.showMessageDialog(null,message);
        allow = true;
        this.dispose();
    ...
    private void greenButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_greenButtonActionPerformed
        ...
        JLabel message = new JLabel("Warna Kartu Wild adalah Hijau!");
        message.setFont(new Font("Arial", Font.BOLD, 48));
        JOptionPane.showMessageDialog(null,message);
        allow = true;
        this.dispose();
    ...
    private void yellowButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yellowButtonActionPerformed
        ...
        JLabel message = new JLabel("Warna Kartu Wild adalah Kuning!");
        message.setFont(new Font("Arial", Font.BOLD, 48));
        JOptionPane.showMessageDialog(null,message);
        allow = true;
        this.dispose();
